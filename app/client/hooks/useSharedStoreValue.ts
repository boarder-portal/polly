...
export interface UseSharedStoreValue<Key extends SharedStoreKey> {
  value: SharedStoreValue<Key>;
  setValue(value: SharedStoreValue<Key> | ((value: SharedStoreValue<Key>) => SharedStoreValue<Key>)): void;
}
